...
function BuyButton(){
    ...
    let coinName = document.getElementById("marketSelect").value;
    ...
    if( order == "pendingOrder"){
        ...
        let buyTotal = adjustPrice(buyMoney * buyNumber);
        document.getElementById("bpbuyTotal").innerHTML = buyTotal;

        let dataObj = new Object();

        dataObj.orderType = "LIMIT";
        dataObj.isBuying = true; //true : 매수
        dataObj.orderState = "UNFILLED";
        dataObj.coinName = coinName;
        ...
        let buyTotal = adjustPrice(document.getElementById("bmbuyTotal").value);
        ...
        let buyTotal = adjustPrice(buyMoney * buyNumber);
        document.getElementById("bobuyTotal").innerHTML = buyTotal;
...
function SellButton(){
    ...
    let coinName = document.getElementById("marketName").textContent;
    ...
    if( order == "pendingOrder"){ //지정가
        ...
        let sellTotal = adjustPrice(sellMoney * sellNumber);
        document.getElementById("spsellTotal").innerHTML = sellTotal;
        ...
        let sellTotal = adjustPrice(document.getElementById("smsellTotal").value);
        ...
        let sellTotal = adjustPrice(sellMoney * sellNumber);
        document.getElementById("sosellTotal").innerHTML = sellTotal;
